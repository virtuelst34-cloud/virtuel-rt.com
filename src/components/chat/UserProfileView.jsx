...
export default function UserProfileView({ targetName, onClose, onOpenDM }) {
  ...
  const targetSpecialBadges = target?.specialBadges || [];
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[2000] animate-in fade-in duration-300 p-4" onClick={onClose}>
      <div className="bg-card border border-border/50 rounded-3xl w-full max-w-[380px] max-h-[90vh] overflow-hidden shadow-[0_32px_96px_rgba(0,0,0,0.5)] animate-in zoom-in-95 duration-300"
        ...
        <div className="px-5 pb-5">
          ...
          <div className="mb-3">
            <div className="flex items-center gap-2 mb-0.5">
              ...
              {targetSpecialBadges.map(specialId => {
